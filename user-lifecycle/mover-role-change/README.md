...
- [Identity Provider reference architecture](../../architecture/identity-provider-reference-architecture/README.md) — where the IGA policy engine sits relative to the IdP.
