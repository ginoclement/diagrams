...
- [Identity Provider reference architecture](../../architecture/identity-provider-reference-architecture/README.md) — where the governance/attestation engine sits in the platform.
