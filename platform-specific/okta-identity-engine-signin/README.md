...
[OIDC Authorization Code + PKCE](../../oidc/authorization-code-pkce/README.md) (or
[SAML SP-initiated SSO](../../saml/sp-initiated-sso/README.md)) flow — this diagram
...
- [OIDC Authorization Code + PKCE](../../oidc/authorization-code-pkce/README.md) — the token-issuance mechanics OIE wraps.
- [SAML SP-Initiated SSO](../../saml/sp-initiated-sso/README.md) — alternative app federation Okta can drive with the same policy layers.
...
- [MFA Enrollment](../../enrollment-and-update/mfa-enrollment/README.md) — the enrollment ceremony OIE can trigger inline.
