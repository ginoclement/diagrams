...
|---|---|---|---|---|---|---|---|
| **Workforce** | Corporate SSO ([SAML](../../authentication/saml/sp-initiated-sso/README.md) / [OIDC](../../authentication/oidc/authorization-code-pkce/README.md)); [by-persona](./authentication-by-persona/README.md) | MFA always on; risk-based step-up | IT/MDM-pushed factors ([by-persona](./enrollment-by-persona/README.md)) | HR-driven joiner→mover→leaver ([JML](../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md), [by-persona](./jml-lifecycle-by-persona/README.md)) | SSPR + helpdesk fallback ([by-persona](./authentication-by-persona/README.md)) | Periodic manager cert ([review](../../identity-lifecycle/user-lifecycle/access-review-certification/README.md), [by-persona](./authentication-by-persona/README.md)) | [RBAC](../../authorization/rbac/README.md) birthright + role bundles |
...
- [JML Orchestration](../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md) — the base lifecycle the
...
- [Access Review & Certification](../../identity-lifecycle/user-lifecycle/access-review-certification/README.md) —
  base review control.
- [MFA Enrollment](../../identity-lifecycle/enrollment-and-update/mfa-enrollment/README.md) /
  [Device Enrollment (MDM)](../../identity-lifecycle/enrollment-and-update/device-enrollment-mdm/README.md) — base enrolment.
- [Self-Service Password Reset](../../identity-lifecycle/password-management/self-service-reset/README.md) — base recovery.
