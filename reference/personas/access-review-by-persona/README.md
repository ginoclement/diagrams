---
title: "Access Review by Persona"
creation: 2026-07-25
...
- [user-lifecycle/access-review-certification](../../../identity-lifecycle/user-lifecycle/access-review-certification/README.md) — the base recertification campaign flow.
- [user-lifecycle/mover-role-change](../../../identity-lifecycle/user-lifecycle/mover-role-change/README.md) — role change that triggers ad-hoc review.
- [user-lifecycle/leaver-offboarding](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md) — the auto-revoke endpoint for lapsed contractor/leaver access.
