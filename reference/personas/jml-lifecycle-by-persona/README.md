---
title: "JML Lifecycle by Persona"
creation: 2026-07-25
...
[JML Orchestration](../../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md) assumes an HR source of
...
- Rehire, out-of-order events, and orphan remediation behave as in the base
  [JML Orchestration](../../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md); persona changes the
  *source and end-state semantics*, not the reconciliation machinery.

## Related diagrams

- [JML Orchestration](../../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md) — the base lifecycle this set forks
- [Joiner Onboarding](../../../identity-lifecycle/user-lifecycle/joiner-onboarding/README.md) / [Mover Role Change](../../../identity-lifecycle/user-lifecycle/mover-role-change/README.md) / [Leaver Offboarding](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md) — the transitions in detail
- [SCIM Provisioning](../../../identity-lifecycle/user-lifecycle/scim-provisioning/README.md) — the wire protocol to apps
