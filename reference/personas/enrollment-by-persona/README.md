...
- Prefer phishing-resistant factors ([FIDO2 / passkey](../../../identity-lifecycle/enrollment-and-update/fido2-passkey-registration/README.md))
  at enrolment for all personas; step up verification before allowing a new factor to replace an existing one.

## Related diagrams

- [MFA Enrollment](../../../identity-lifecycle/enrollment-and-update/mfa-enrollment/README.md) — base factor registration
- [Device Enrollment (MDM)](../../../identity-lifecycle/enrollment-and-update/device-enrollment-mdm/README.md) / [Certificate Enrollment (SCEP/EST)](../../../identity-lifecycle/enrollment-and-update/certificate-enrollment-scep-est/README.md) — workforce/device base flows
- [FIDO2 / Passkey Registration](../../../identity-lifecycle/enrollment-and-update/fido2-passkey-registration/README.md) — phishing-resistant factor enrolment
- [Email / Phone Verification](../../../identity-lifecycle/enrollment-and-update/email-phone-verification/README.md) — consumer/guest proof-of-control base flow
