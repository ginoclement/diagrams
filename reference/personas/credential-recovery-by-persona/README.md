---
title: "Credential Recovery by Persona"
creation: 2026-07-25
...
- [password-management/self-service-reset](../../../identity-lifecycle/password-management/self-service-reset/README.md) — the consumer/workforce SSPR base flow.
- [password-management/admin-initiated-reset](../../../identity-lifecycle/password-management/admin-initiated-reset/README.md) — the helpdesk-driven reset detail.
- [password-management/account-unlock](../../../identity-lifecycle/password-management/account-unlock/README.md) — lockout vs credential loss.
