...
- **Build new on OIDC** → [`../../oidc/authorization-code-pkce/`](../../../authentication/oidc/authorization-code-pkce/README.md)
- **Migrate SP to OIDC** → [`../../oidc/authorization-code-pkce/`](../../../authentication/oidc/authorization-code-pkce/README.md) (server-side web app: [`../../oidc/authorization-code/`](../../../authentication/oidc/authorization-code/README.md))
- **Coexistence (SAML + OIDC in parallel)** → target [`../../oidc/authorization-code-pkce/`](../../../authentication/oidc/authorization-code-pkce/README.md), source [`../../saml/sp-initiated-sso/`](../../../authentication/saml/sp-initiated-sso/README.md)
- **🟡 Keep SAML** → [`../../saml/sp-initiated-sso/`](../../../authentication/saml/sp-initiated-sso/README.md); replacement when unblocked [`../../oidc/authorization-code-pkce/`](../../../authentication/oidc/authorization-code-pkce/README.md)
