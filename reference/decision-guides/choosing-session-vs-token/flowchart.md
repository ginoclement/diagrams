...
- **Use Server-side session cookie** → [`../../tokenless/session-cookie/`](../../../authentication/tokenless/session-cookie/README.md)
- **Use Stateless JWT** → [`../../oidc/authorization-code-pkce/`](../../../authentication/oidc/authorization-code-pkce/README.md) (JWT access/ID tokens)
- **Use Reference token + introspection** → [`../../oidc/authorization-code/`](../../../authentication/oidc/authorization-code/README.md) (confidential client issues/holds the opaque token)
