...
- [Authorization Code + PKCE](../../../authentication/oidc/authorization-code-pkce/README.md) — issues JWT/access tokens.
- [Authorization Code (confidential)](../../../authentication/oidc/authorization-code/README.md) — server-side token handling.
