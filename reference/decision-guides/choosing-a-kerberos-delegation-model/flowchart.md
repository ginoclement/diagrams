...
- **Use Resource-Based Constrained Delegation** → [`../../kerberos/resource-based-constrained-delegation/`](../../../authentication/kerberos/resource-based-constrained-delegation/README.md)
- **Use Constrained Delegation (S4U2Proxy)** → [`../../kerberos/constrained-delegation/`](../../../authentication/kerberos/constrained-delegation/README.md)
- **No delegation** → [`../../kerberos/tgs-exchange/`](../../../authentication/kerberos/tgs-exchange/README.md) (standard service ticket, no impersonation)
- **⛔ Unconstrained delegation** → replacement [`../../kerberos/resource-based-constrained-delegation/`](../../../authentication/kerberos/resource-based-constrained-delegation/README.md) (reference: [`../../kerberos/unconstrained-delegation/`](../../../authentication/kerberos/unconstrained-delegation/README.md))
