...
- Issuing certificates for Wi-Fi (EAP-TLS), VPN, or [mutual TLS](../../tokenless/mutual-tls/README.md).
...
- [Mutual TLS](../../tokenless/mutual-tls/README.md) — using the issued certificate as a client credential.
- [PKINIT](../../kerberos/pkinit/README.md) — certificate-based Kerberos initial authentication using such certs.
