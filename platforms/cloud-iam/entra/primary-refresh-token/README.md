...
- [OIDC Authorization Code + PKCE](../../../../authentication/oidc/authorization-code-pkce/README.md) — the token protocol underneath brokered auth
- [Kerberos SSO](../../../../authentication/kerberos/README.md) — the on-prem SSO analogue (Cloud Kerberos ties them)
