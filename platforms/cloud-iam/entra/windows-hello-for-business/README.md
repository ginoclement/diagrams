...
- [Kerberos authentication](../../../../authentication/kerberos/pkinit/README.md) — PKINIT / Cloud Kerberos trust reaches on-prem resources
- [WebAuthn / Passkey authentication](../../../../authentication/tokenless/webauthn-passkey-authentication/README.md) — the FIDO2 cousin of this credential model
