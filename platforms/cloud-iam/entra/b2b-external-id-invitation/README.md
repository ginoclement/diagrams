...
- [SAML SP-initiated SSO](../../../../authentication/saml/sp-initiated-sso/README.md) — federation protocol behind SAML-based home IdPs
- [OIDC Authorization Code + PKCE](../../../../authentication/oidc/authorization-code-pkce/README.md) — the sign-in protocol at redemption
- [Guest / external persona](../../../../reference/personas/README.md) — persona variance for external users
