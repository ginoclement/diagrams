...
- The IdP posts a base64 `SAMLResponse` to the AWS ACS URL (HTTP-POST binding), exactly as
  in generic [SP-initiated SSO](../../../../authentication/saml/sp-initiated-sso/README.md) — AWS is the SP.
...
- [SAML SP-initiated SSO](../../../../authentication/saml/sp-initiated-sso/README.md) — the generic browser SSO AWS relies on as SP.
