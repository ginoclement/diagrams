---
title: "Okta FastPass — Device-Bound Passwordless Authentication"
creation: 2026-07-25
...
- [WebAuthn / Passkey Authentication](../../../authentication/tokenless/webauthn-passkey-authentication/README.md) — the generic phishing-resistant signature ceremony FastPass parallels.
...
- [OIDC Authorization Code + PKCE](../../../authentication/oidc/authorization-code-pkce/README.md) — the token issuance that follows a successful factor.
- [FIDO2 / Passkey Registration](../../../identity-lifecycle/enrollment-and-update/fido2-passkey-registration/README.md) — parallel device-key enrollment ceremony.
