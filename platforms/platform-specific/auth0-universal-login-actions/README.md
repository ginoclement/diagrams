---
title: "Auth0 Universal Login + Actions (Post-Login Pipeline)"
creation: 2026-07-25
...
- [OIDC Authorization Code + PKCE](../../../authentication/oidc/authorization-code-pkce/README.md) — the login + token issuance Universal Login implements.
- [OAuth 2.0 Client Credentials](../../../authentication/oidc/client-credentials/README.md) — the M2M grant the credentials-exchange Action extends.
