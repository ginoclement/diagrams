...
[OIDC](../../../authentication/oidc/authorization-code/README.md) /
[SAML](../../../authentication/saml/sp-initiated-sso/README.md) machinery — not re-drawn here. What is
...
- [OIDC Authorization Code Flow](../../../authentication/oidc/authorization-code/README.md) — where the token inline hook fires at issuance.
- [SAML SP-Initiated SSO](../../../authentication/saml/sp-initiated-sso/README.md) — where the SAML assertion inline hook fires before signing.
- [Okta Identity Engine Sign-In](../okta-identity-engine-signin/README.md) — the sign-in pipeline hooks extend.
- [SCIM Provisioning](../../../identity-lifecycle/user-lifecycle/scim-provisioning/README.md) — parallel outbound integration pattern (push vs synchronous callout).
