---
title: "platform-specific — Vendor-Specific Identity Flows"
creation: 2026-07-25
...
- [OIDC Authorization Code](../../authentication/oidc/authorization-code/README.md)
- [OAuth 2.0 Client Credentials](../../authentication/oidc/client-credentials/README.md)
- [CIBA](../../authentication/oidc/ciba/README.md)
- [SAML SP-Initiated SSO](../../authentication/saml/sp-initiated-sso/README.md)
- [WebAuthn / Passkey Authentication](../../authentication/tokenless/webauthn-passkey-authentication/README.md)
- [FIDO2 / Passkey Registration](../../identity-lifecycle/enrollment-and-update/fido2-passkey-registration/README.md)
