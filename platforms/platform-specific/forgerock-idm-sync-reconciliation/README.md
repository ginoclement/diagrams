...
[SCIM](../../../identity-lifecycle/user-lifecycle/scim-provisioning/README.md) — not re-drawn here. What is
...
- [SCIM Provisioning](../../../identity-lifecycle/user-lifecycle/scim-provisioning/README.md) — the standards-based provisioning alternative.
...
- [JML Orchestration](../../../identity-lifecycle/user-lifecycle/jml-orchestration/README.md) — joiner/mover/leaver events that drive sync.
- [Leaver / Offboarding](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md) — deprovisioning that maps to UNQUALIFIED.
