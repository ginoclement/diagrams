...
- **No network-location trust:** the PEP challenges every request regardless of source
  ...
  differs from [IP-allowlist network auth](../../../authentication/tokenless/ip-allowlist-network-auth/README.md),
...
- [Mutual TLS client-cert auth](../../../authentication/tokenless/mutual-tls/README.md) — device/workload identity for posture
- [IP-allowlist network auth](../../../authentication/tokenless/ip-allowlist-network-auth/README.md) — the location-based model zero trust rejects
