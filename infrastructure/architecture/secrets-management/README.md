---
title: "Secrets Management Platform (Vault-style)"
creation: 2026-07-25
...
[mTLS](../../../authentication/tokenless/mutual-tls/README.md).
...
- **The store is only as trustworthy as its auth methods.** A workload proves identity
  ...
  or an [mTLS client cert](../../../authentication/tokenless/mutual-tls/README.md) — never a static password.
...
- [Mutual TLS client-cert auth](../../../authentication/tokenless/mutual-tls/README.md) — an auth method for workloads
- [OAuth 2.0 Client Credentials](../../../authentication/oidc/client-credentials/README.md) — machine identity for app auth
