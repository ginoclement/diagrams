...
This is the trust anchor behind [mTLS](../../../authentication/tokenless/mutual-tls/README.md), token/assertion
...
[certificate enrollment (SCEP/EST)](../../../identity-lifecycle/enrollment-and-update/certificate-enrollment-scep-est/README.md).
...
- [Mutual TLS client-cert auth](../../../authentication/tokenless/mutual-tls/README.md) — leaf certs used for authentication
- [Certificate enrollment (SCEP/EST)](../../../identity-lifecycle/enrollment-and-update/certificate-enrollment-scep-est/README.md) — how end entities enroll
