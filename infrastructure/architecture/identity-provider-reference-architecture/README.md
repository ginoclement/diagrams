...
protocol flows that run *through* this architecture live in the [OIDC](../../../authentication/oidc/authorization-code-pkce/README.md)
and [SAML](../../../authentication/saml/sp-initiated-sso/README.md) categories.
...
- [OIDC Authorization Code + PKCE](../../../authentication/oidc/authorization-code-pkce/README.md) — a login flow through this IdP
- [SAML SP-initiated SSO](../../../authentication/saml/sp-initiated-sso/README.md) — a federation flow through this IdP
