...
- [Cloud IAM](../../platforms/cloud-iam/README.md) — the cloud side of OIDC federation:
  [AWS AssumeRoleWithWebIdentity](../../platforms/cloud-iam/aws/assumerole-web-identity-oidc/README.md),
...
- [OIDC flows](../../authentication/oidc/README.md) — the token format and validation reused by CI-to-cloud
