...
- [AWS AssumeRoleWithWebIdentity (OIDC)](../../../platforms/cloud-iam/aws/assumerole-web-identity-oidc/README.md) — the STS exchange in detail.
- [GCP Workload Identity Federation](../../../platforms/cloud-iam/gcp/workload-identity-federation/README.md) — the GCP variant.
- [Entra workload identity federation](../../../platforms/cloud-iam/entra/workload-identity-federation/README.md) — the Azure variant.
