...
- [IP allowlist / network-location authentication](../../../authentication/tokenless/ip-allowlist-network-auth/README.md) — the "on the network = trusted" assumption VPNs create.
