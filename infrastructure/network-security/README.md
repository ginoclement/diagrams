...
side of security and identity. Where [saml/](../../authentication/saml), [oidc/](../../authentication/oidc), and
[kerberos/](../../authentication/kerberos) establish *who* a caller is, these diagrams cover *how traffic
...
- [tokenless/](../../authentication/tokenless) — [mutual-tls](../../authentication/tokenless/mutual-tls/README.md), [header-based-sso](../../authentication/tokenless/header-based-sso/README.md), and [ip-allowlist-network-auth](../../authentication/tokenless/ip-allowlist-network-auth/README.md) connect directly to these transport and perimeter controls.
...
- [oidc/](../../authentication/oidc) and [saml/](../../authentication/saml) — the federated identity layered on top of the secured transport shown here.
