...
| **Break-glass** | Sealed local credential, bypasses federation | Offline/second-channel factor; alert on use | Provisioned once, sealed; periodic rehearsal | Created deliberately; reviewed, never auto-JML | **Reseal + rotate** after any use; no SSPR ([by-persona](credential-recovery-by-persona/README.md)) | Every use audited; existence reviewed ([by-persona](access-review-by-persona/README.md)) | Standing max privilege, use-gated + alerted |
| **Developer** | [OIDC dev client](../oidc/authorization-code-pkce/README.md) + [device-code](../oidc/device-authorization/README.md) for CLIs | MFA on human auth; tokens short-lived | Self-service key/PAT/client issuance ([by-persona](enrollment-by-persona/README.md)) | Workforce lifecycle for the human; keys rotate/expire | Reissue PAT/key; short-lived token refresh ([by-persona](credential-recovery-by-persona/README.md)) | Key/PAT usage + scope review | [Scopes/claims](../authorization/scopes-claims-entitlements/README.md); least-privilege tokens |
...
- [credential-recovery-by-persona](credential-recovery-by-persona/README.md) — consumer SSPR
  vs workforce SSPR+helpdesk vs privileged vaulted (no direct reset) vs workload rotate.
- [access-review-by-persona](access-review-by-persona/README.md) — cadence and approver
