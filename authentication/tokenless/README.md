...
- [network-security/zero-trust-network-access](../../infrastructure/architecture/zero-trust-architecture/README.md) — the modern replacement for network-location-based trust.
- [enrollment/passkey-enrollment](../../identity-lifecycle/enrollment-and-update/fido2-passkey-registration/README.md) — how the credentials used in the WebAuthn ceremony get created.
