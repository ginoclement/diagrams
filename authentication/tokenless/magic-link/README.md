...
- [Self-service password reset](../../../identity-lifecycle/password-management/self-service-reset/README.md) — the same mechanism guarding password recovery.
- [Auth0 lazy migration](../../../platforms/platform-specific/auth0-universal-login-actions/README.md) — passwordless options during migration.
