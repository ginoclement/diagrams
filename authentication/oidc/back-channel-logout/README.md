...
- Session revocation triggered without any browser: admin "kill sessions", account
  compromise response, password reset, [leaver deprovisioning](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md).
...
- [Leaver](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md) — deprovisioning scenario that fires back-channel logout at scale.
