...
- [MFA Enrollment](../../../identity-lifecycle/enrollment-and-update/mfa-enrollment/README.md) — how the authentication device gets registered in the first place.
- [Okta FastPass](../../../platforms/platform-specific/okta-fastpass-passwordless/README.md) — a vendor take on phishing-resistant device-bound authentication.
