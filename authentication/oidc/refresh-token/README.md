...
- Revoke the family on logout ([RP-Initiated Logout](../rp-initiated-logout/README.md)),
  password change, and [leaver events](../../../identity-lifecycle/user-lifecycle/leaver-offboarding/README.md).
...
- [Password Self-Service Reset](../../../identity-lifecycle/password-management/self-service-reset/README.md) — an event that must revoke refresh tokens.
