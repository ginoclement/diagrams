---
title: "Single Logout — SP-Initiated — Sample Capture"
creation: 2026-07-25
...
# Single Logout — SP-Initiated — Sample Capture
...
- HAR capture: [`slo-sp-initiated.har`](./slo-sp-initiated.har) — HTTP-level view of the exchange (load it into the browser Network tab or a HAR viewer).
