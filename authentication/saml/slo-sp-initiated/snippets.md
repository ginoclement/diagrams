---
title: "Single Logout — SP-Initiated — Client Snippets"
creation: 2026-07-25
...
# Single Logout — SP-Initiated — Client Snippets
...
Snippets for the Single Logout messages: encoding a `LogoutRequest` for the HTTP-Redirect binding, POSTing/redirecting the `LogoutResponse`, and driving SLO from an SDK. In this flow the SP initiates logout.
...
```bash
curl -i -G 'https://idp.example.net/slo/redirect' \
