...
- [Kerberos PKINIT](../../kerberos/pkinit/README.md) — smartcard/PIV certificate logon.
- [Okta FastPass passwordless](../../platform-specific/okta-fastpass-passwordless/README.md) — a push/passwordless example.
- [Adaptive access](../../adaptive-access/README.md) — when to step up.
