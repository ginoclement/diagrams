...
- **Use OIDC - Authorization Code + PKCE** → [`../../oidc/authorization-code-pkce/`](../../oidc/authorization-code-pkce/README.md)
- **Use OIDC: client credentials** → [`../../oidc/client-credentials/`](../../oidc/client-credentials/README.md) (and the [OAuth grant guide](../choosing-an-oauth-grant/README.md))
- **Use SAML 2.0** → [`../../saml/sp-initiated-sso/`](../../saml/sp-initiated-sso/README.md)
- **Use Kerberos - SPNEGO** → [`../../kerberos/spnego-http/`](../../kerberos/spnego-http/README.md)
- **Use Tokenless: Mutual TLS** → [`../../tokenless/mutual-tls/`](../../tokenless/mutual-tls/README.md)
- **Use Tokenless: Session cookie** → [`../../tokenless/session-cookie/`](../../tokenless/session-cookie/README.md)
- **Use Tokenless: API key / session** → [`../../tokenless/session-cookie/`](../../tokenless/session-cookie/README.md)
