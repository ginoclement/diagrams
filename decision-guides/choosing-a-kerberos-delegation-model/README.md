...
- [Resource-based constrained delegation](../../kerberos/resource-based-constrained-delegation/README.md)
- [Constrained delegation (S4U2Proxy)](../../kerberos/constrained-delegation/README.md)
- [Unconstrained delegation](../../kerberos/unconstrained-delegation/README.md) — deprecated, kept for reference.
- [TGS exchange](../../kerberos/tgs-exchange/README.md) — the underlying ticket mechanics.
