...
public client uses the [Authorization Code flow with PKCE](../../../oidc/authorization-code-pkce/README.md)
...
- [OIDC Authorization Code + PKCE](../../../oidc/authorization-code-pkce/README.md) — the flow the Hosted UI implements for public clients.
- [OIDC Implicit](../../../oidc/implicit/README.md) — the legacy flow to avoid for SPAs.
- [SAML SP-initiated SSO](../../../saml/sp-initiated-sso/README.md) — enterprise federation feeding the pool.
