...
- [OIDC Authorization Code + PKCE](../../../oidc/authorization-code-pkce/README.md) — the CLI login token flow.
- [SAML SP-initiated SSO](../../../saml/sp-initiated-sso/README.md) — external IdP sign-in feeding the identity source.
