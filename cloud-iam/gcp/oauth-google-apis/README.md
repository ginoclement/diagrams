...
- [Authorization Code (confidential)](../../../oidc/authorization-code/README.md) — the generic OIDC flow this specializes.
- [Authorization Code + PKCE](../../../oidc/authorization-code-pkce/README.md) — the public-client hardening applied here.
- [Refresh Token](../../../oidc/refresh-token/README.md) — the offline-token rotation model.
