...
- [Kerberos AS Exchange](../../../authentication/kerberos/as-exchange/README.md) — what SASL `GSSAPI` binds rely on
- [Mutual TLS](../../../authentication/tokenless/mutual-tls/README.md) — the transport behind SASL `EXTERNAL`
- [HTTP Basic Authentication](../../../authentication/tokenless/http-basic-auth/README.md) — the app-tier equivalent of simple bind
