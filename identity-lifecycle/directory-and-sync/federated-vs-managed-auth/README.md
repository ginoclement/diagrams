...
- Managed auth centralizes control in the cloud, enabling
  [Conditional Access](../../../platforms/cloud-iam/entra/conditional-access-evaluation/README.md),
...
- [SP-Initiated SSO](../../../authentication/saml/sp-initiated-sso/README.md) — the SAML redirect pattern the federated path uses
- [IdP-Initiated SSO](../../../authentication/saml/idp-initiated-sso/README.md) — the unsolicited SAML variant from an on-prem IdP
- [Conditional Access Evaluation](../../../platforms/cloud-iam/entra/conditional-access-evaluation/README.md) — policy layered on the managed path
