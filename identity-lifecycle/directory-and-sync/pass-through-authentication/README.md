...
- PTA validates the password but not device or session risk — layer
  [Conditional Access](../../../platforms/cloud-iam/entra/conditional-access-evaluation/README.md) and
...
- [Conditional Access Evaluation](../../../platforms/cloud-iam/entra/conditional-access-evaluation/README.md) — risk and policy layered after the password check
- [Primary Refresh Token](../../../platforms/cloud-iam/entra/primary-refresh-token/README.md) — the device-bound token issued after cloud sign-in
