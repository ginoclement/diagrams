...
- PHS is a facet of the broader
  [Entra hybrid identity sync](../../../platforms/cloud-iam/entra/hybrid-identity-sync/README.md) that also
...
- [Entra Hybrid Identity Sync](../../../platforms/cloud-iam/entra/hybrid-identity-sync/README.md) — the full directory sync PHS is part of
- [HR-Driven Inbound Provisioning](../hr-driven-inbound-provisioning/README.md) — how the accounts being synced are created
- [Conditional Access Evaluation](../../../platforms/cloud-iam/entra/conditional-access-evaluation/README.md) — policy applied at the cloud sign-in
