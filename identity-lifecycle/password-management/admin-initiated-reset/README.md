...
- **Revoke sessions** — see [session-cookie](../../../authentication/tokenless/session-cookie/README.md)
  and [RP-initiated logout](../../../authentication/oidc/rp-initiated-logout/README.md).
...
- [identity-provider-reference-architecture](../../../infrastructure/architecture/identity-provider-reference-architecture/README.md) — where the admin console and audit log sit.
