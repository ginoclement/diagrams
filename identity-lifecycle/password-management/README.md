...
- [tokenless/](../../authentication/tokenless) — the session-cookie and passwordless login flows these credentials protect.
- [oidc/](../../authentication/oidc) — federated login and [RP-initiated logout](../../authentication/oidc/rp-initiated-logout/README.md) used for session revocation.
...
- [architecture/](../../infrastructure/architecture) — where the auth server, directory, and audit log that back these flows sit.
