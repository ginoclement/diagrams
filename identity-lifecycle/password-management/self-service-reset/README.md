...
- **Invalidate old sessions:** on a successful reset, destroy all existing sessions and
  ...
  compromised. See [session-cookie](../../../authentication/tokenless/session-cookie/README.md) and
...
- [session-cookie](../../../authentication/tokenless/session-cookie/README.md) — the sessions that must be invalidated on reset.
