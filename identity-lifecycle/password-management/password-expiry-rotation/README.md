...
- **Revoke stale sessions** issued under the old password where the rotation is
  compromise-driven — see [session-cookie](../../../authentication/tokenless/session-cookie/README.md).
...
- [session-cookie](../../../authentication/tokenless/session-cookie/README.md) — the session that is withheld until the change completes.
