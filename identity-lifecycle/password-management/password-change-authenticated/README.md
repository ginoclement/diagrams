...
- **Session decision after change:** offer to **keep the current session but kill all
  ...
  See [session-cookie](../../../authentication/tokenless/session-cookie/README.md) and
...
- [session-cookie](../../../authentication/tokenless/session-cookie/README.md) — the sessions kept or killed after the change.
