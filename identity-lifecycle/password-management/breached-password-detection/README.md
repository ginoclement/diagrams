...
- SHA-1 is used here only as a **corpus index**, not to store passwords. Persist accepted
  ...
  [Directory](../../../infrastructure/architecture/identity-provider-reference-architecture/README.md).
...
- [identity-provider-reference-architecture](../../../infrastructure/architecture/identity-provider-reference-architecture/README.md) — where password hashing and screening sit.
