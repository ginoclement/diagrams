...
- [Identity Provider reference architecture](../../../infrastructure/architecture/identity-provider-reference-architecture/README.md) — the platform these components live in.
- [RP-Initiated Logout](../../../authentication/oidc/rp-initiated-logout/README.md) / [Session Cookie](../../../authentication/tokenless/session-cookie/README.md) — the runtime sessions leaver events must terminate.
