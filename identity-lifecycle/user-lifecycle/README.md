...
- [oidc/](../../authentication/oidc) — the runtime login flows that consume the accounts these processes create.
- [saml/](../../authentication/saml) — enterprise assertion-based federation into the same downstream apps.
- [tokenless/](../../authentication/tokenless) — the sessions and cookies a leaver's offboarding must destroy.
