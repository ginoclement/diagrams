...
- [RP-Initiated Logout](../../../authentication/oidc/rp-initiated-logout/README.md) — one mechanism for ending the IdP session being revoked.
- [SAML Single Logout (SP-Initiated)](../../../authentication/saml/slo-sp-initiated/README.md) — propagating session termination to federated apps.
- [Session Cookie](../../../authentication/tokenless/session-cookie/README.md) — the local sessions that must be invalidated, not just the federated ones.
