---
title: "FIDO2 / Passkey Registration Ceremony"
creation: 2026-07-25
...
[tokenless/webauthn-passkey-authentication](../../../authentication/tokenless/webauthn-passkey-authentication/README.md).
...
- [WebAuthn / passkey authentication](../../../authentication/tokenless/webauthn-passkey-authentication/README.md) — the assertion ceremony that uses the credential registered here.
- [MFA enrollment](../mfa-enrollment/README.md) — registering a shared-secret factor as the phishable alternative.
- [Mutual TLS](../../../authentication/tokenless/mutual-tls/README.md) — another public-key, phishing-resistant credential model.
