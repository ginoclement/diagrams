...
in the loop. Where [oidc/](../authentication/oidc) and [saml/](../authentication/saml) authenticate people, these
...
- [cloud-iam/](../platforms/cloud-iam) — concrete implementations of these patterns:
  ...
  [gcp/gke-workload-identity](../platforms/cloud-iam/gcp/gke-workload-identity/README.md),
  [gcp/application-default-credentials](../platforms/cloud-iam/gcp/application-default-credentials/README.md),
  [entra/managed-identity-imds](../platforms/cloud-iam/entra/managed-identity-imds/README.md),
  [entra/workload-identity-federation](../platforms/cloud-iam/entra/workload-identity-federation/README.md).
- [network-security/](../infrastructure/network-security) — [mtls-service-mesh](../infrastructure/network-security/mtls-service-mesh/README.md) consumes the SVIDs and bootstrap certs minted here.
- [tokenless/](../authentication/tokenless) — [mutual-tls](../authentication/tokenless/mutual-tls/README.md) is the steady-state use of the certificate a workload bootstraps.
- [oidc/](../authentication/oidc) — the token-exchange and JWKS validation these federation flows rely on.
</content>
</invoke>
