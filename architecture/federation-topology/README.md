...
[SAML](../../saml/sp-initiated-sso/README.md) and [OIDC](../../oidc/authorization-code/README.md)
...
- [SAML SP-initiated SSO](../../saml/sp-initiated-sso/README.md) — a single upstream/downstream SAML leg
- [OIDC Authorization Code](../../oidc/authorization-code/README.md) — a single OIDC leg to a social/enterprise IdP
- [Kerberos cross-realm](../../kerberos/cross-realm/README.md) — the Kerberos analogue of brokered cross-domain trust
