...
[OIDC category](../../oidc/authorization-code-pkce/README.md).
...
- **Do not forward the caller's token downstream unchanged.** Use
  [token exchange](../../oidc/client-credentials/README.md) to mint a service-scoped,
...
- [OIDC Authorization Code + PKCE](../../oidc/authorization-code-pkce/README.md) — how a client obtains the token
- [OAuth 2.0 Client Credentials](../../oidc/client-credentials/README.md) — machine tokens + token exchange downstream
