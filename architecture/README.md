...
rather than single-protocol message flows. Where the [SAML](../saml/README.md),
[OIDC](../oidc/README.md), [Kerberos](../kerberos/README.md), and
[tokenless](../tokenless/README.md) categories show individual protocol exchanges, these
...
- [SAML](../saml/README.md) and [OIDC](../oidc/README.md) — the federation protocol flows that run through the IdP and federation topologies.
- [Kerberos](../kerberos/README.md) — [cross-realm](../kerberos/cross-realm/README.md) trust, the on-prem analogue of brokered federation.
- [Tokenless](../tokenless/README.md) — [mutual TLS](../tokenless/mutual-tls/README.md) and session patterns used as workload identity and enforcement.
- [Enrollment & update](../enrollment-and-update/certificate-enrollment-scep-est/README.md) — how end entities enroll into the PKI hierarchy.
